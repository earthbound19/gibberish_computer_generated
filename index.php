...
// TO DO? Ouptut a proper plain text header from the server if a ?gib value is passed to this script via GET (see comments later)?
...
$gibStr = $_GET["gib"];
// IF NO "gib" parameter is passed to this script via GET (e.g. ?gib=flarlaugh), print gib with other HTML. If such a parameter is passed, print only plain text gibberish.
// print("<p>Gibberish string passed to script via GET is: " . $gibStr);
if ($gibStr != "") {
  //print("<p>GET value of " . $gibStr . " passed to page.");
